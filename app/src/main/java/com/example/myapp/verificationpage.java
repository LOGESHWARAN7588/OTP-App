...
public class verificationpage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if (!inputnumber1.getText().toString().trim().isEmpty() && !inputnumber2.getText().toString().trim().isEmpty() && !inputnumber3.getText().toString().trim().isEmpty() && !inputnumber4.getText().toString().trim().isEmpty() && !inputnumber5.getText().toString().trim().isEmpty() && !inputnumber6.getText().toString().trim().isEmpty()) {
                    ...
                    if (getotpbackend != null) {
                        ...
                        Toast.makeText(verificationpage.this,"please check the Internet connection", Toast.LENGTH_SHORT).show();

                    }


                    //Toast.makeText(verificationpage.this, "otp verify", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(verificationpage.this, "please enter all number", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        TextView resendlabel1 = findViewById(R.id.textresentopt);
                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        ...
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                ...
                                Toast.makeText(verificationpage.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            ...
                            public void onCodeSent(@NonNull String newbackendotp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                Toast.makeText(verificationpage.this, "OTP succussfully", Toast.LENGTH_SHORT).show();
